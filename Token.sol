...
contract Token is ERC20Detailed, ERC20Mintable, ERC20Burnable {
    ...
    constructor(string memory _name, string memory _symbol, uint8 _decimals, uint256 _feePercentage, uint256 _initialSupplyWithoutDecimals)
    public
    ...
    function transfer(address _recipient, uint256 _amount) public returns (bool) {
        ...
        uint remaining = _amount.sub(fee);

        burn(fee);
        super.transfer(_recipient, remaining);
